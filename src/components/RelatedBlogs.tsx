...
export default function RelatedBlogs({ currentSlug = '', limit = 3, title = 'Related Blog Posts', category }: RelatedBlogsProps) {
    const articles = getRelatedBlogPosts(currentSlug, limit, category);
