 ...
 * Publisher ID: ca-pub-1373076230922603
 *
 * HOW TO GET YOUR SLOT IDs:
 * 1. Log in to https://adsense.google.com
 * 2. Go to Ads → By ad unit → New ad unit
 * 3. Create an ad unit and copy the "data-ad-slot" number
 * 4. Replace the placeholder values below with your real slot IDs
 */
