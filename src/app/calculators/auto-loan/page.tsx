...
export default function AutoLoanPage() {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-fade-in">
            <div className="mb-8">
                <h1 className="text-3xl font-black text-navy-900 dark:text-white mb-2">Auto Loan Calculator</h1>
                <p className="text-gray-500 dark:text-gray-400 max-w-2xl">
                    Calculate your monthly car payment including taxes, trade-in, and download your full amortization schedule.
                </p>
            </div>
