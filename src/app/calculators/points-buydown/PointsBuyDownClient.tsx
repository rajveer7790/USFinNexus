...
export default function PointsBuyDownClient() {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 animate-fade-in">
            <div className="mb-8">
                <h1 className="text-2xl sm:text-3xl md:text-5xl font-black text-navy-900 mb-4">Mortgage Points Buy-Down Calculator 2026</h1>
                <p className="text-gray-500 max-w-2xl font-medium text-lg">
                    Analyze whether paying discount points upfront to reduce your interest rate is worth it in 2026. 
                    Compare the cost of points against monthly savings to find your break-even month.
                </p>
            </div>
