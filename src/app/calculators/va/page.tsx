...
export const metadata: Metadata = {
    title: 'VA Loan Calculator 2026 - VA Funding Fee and Payments',
    description:
    ...
    openGraph: {
        type: 'website',
        title: 'VA Loan Calculator 2026 - Zero Down Payment',
    ...
    twitter: {
        ...
        title: 'VA Loan Calculator 2026 — 0% Down VA Funding Fee',
