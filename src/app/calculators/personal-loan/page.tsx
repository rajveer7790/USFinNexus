...
export default function PersonalLoanPage() {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-fade-in">
            <div className="mb-8">
                <h1 className="text-3xl font-black text-navy-900 dark:text-white mb-2">Personal Loan & Debt Payoff Calculator</h1>
                <p className="text-gray-500 dark:text-gray-400 max-w-2xl">
                    Calculate monthly payment, total interest, and payoff schedule for any personal loan or debt.
                </p>
            </div>
                        ...
                        <div className="flex flex-wrap gap-2">
                            {TERM_OPTIONS.map(t => (
                                <button
                                    ...
                                    className={`px-3 py-1.5 rounded-lg text-xs font-semibold border transition-all ${termMonths === t ? 'text-white border-transparent' : 'border-current'}`}
                ...
                <div className="xl:col-span-3 space-y-5">
                    <div className="card p-6 animate-slide-up">
                        <div className="text-center mb-6">
                            <p className="text-xs font-bold uppercase tracking-widest mb-1" style={{ color: 'var(--color-text-muted)' }}>Monthly Payment</p>
