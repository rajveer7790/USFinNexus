    ...
    return (
        ...
        <div className="max-w-4xl mx-auto px-4 py-7 sm:py-9">
            ...
            <div className="prose prose-lg max-w-none">
                <p className="lead text-xl font-medium mb-8">Understand the difference between pre-qualification and pre-approval, and why it matters when shopping for homes.</p>
