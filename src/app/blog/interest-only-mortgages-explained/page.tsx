...
export const metadata: Metadata = {
    ...
    alternates: {
        canonical: 'https://usfinnexus.com/blog/interest-only-mortgages-explained',
    },
};
        ...
        <div className="max-w-4xl mx-auto px-4 py-7 sm:py-9">
            ...
            <header className="mb-10">
                ...
                <h1 className="text-3xl md:text-5xl font-black mb-6 leading-tight" style={{ color: 'var(--color-text)' }}>
                    Interest-Only Mortgages: When They Make Sense (and Usually Don't)
                </h1>
            ...
            <div className="prose prose-lg max-w-none" style={{ color: 'var(--color-text)' }}>
                <p className="lead text-xl font-medium mb-8" style={{ color: 'var(--color-text-muted)' }}>
                    Interest-only loans lower payments early but carry hidden risks. Understand the tradeoffs.
                </p>
