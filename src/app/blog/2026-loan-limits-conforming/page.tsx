...
export const metadata: Metadata = {
    title: '2026 Conforming Loan Limits: Conventional, FHA, and VA Guide | USFinNexus',
        ...
        <div className="max-w-4xl mx-auto px-4 py-7 sm:py-9">
            ...
            <div className="prose prose-lg max-w-none" style={{ color: 'var(--color-text)' }}>
                ...
                <div className="bg-white p-8 rounded-3xl border border-slate-200 my-10 shadow-sm">
                    ...
                    <h3 className="text-2xl font-bold mt-8 mb-4 text-slate-800">What Are the Top Consumer Finance Questions for 2026?</h3>
