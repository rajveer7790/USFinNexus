        ...
        <main id="main-content" className="mx-auto max-w-5xl px-4 py-8 sm:px-6">
            ...
            <article>
                ...
                <div className="prose prose-slate mx-auto max-w-3xl prose-headings:font-black prose-a:text-blue-700">
                    ...
                    <p>For related planning, compare estimated household tax effects with the <Link href="/calculators/income-tax">Income Tax Calculator</Link> and model other high-interest balances with the <Link href="/calculators/debt-payoff">Debt Payoff Calculator</Link>. These tools are planning aids, not SNAP eligibility decisions.</p>
