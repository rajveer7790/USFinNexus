    ...
    { '@type': 'Question', name: 'How does a Bank Statement Loan work?', acceptedAnswer: { '@type': 'Answer', text: 'This is the most popular Non-QM loan for entrepreneurs. Instead of demanding your tax returns and W-2s, the bank asks for your last 12 to 24 months of business bank statements. They simply look at all the gross deposits entering your account. If the massive deposits prove you run a highly profitable business, they approve the loan.' } },
        ...
        <div className="max-w-4xl mx-auto px-4 py-7 sm:py-9">
            ...
            <div className="prose prose-lg max-w-none" style={{ color: 'var(--color-text)' }}>
                ...
                <p>
                    This is the absolute best loan for entrepreneurs and freelancers.
                </p>
                <p>
                ...
                <p>
                    The underwriter simply tallies up every single dollar deposited into your account over the last year. If you had $240,000 in gross deposits, they will assume your business generates $20,000 a month in revenue. They will typically apply a standard 50% "expense ratio" and declare your official qualifying income to be $10,000 a month. You are approved, and your tax returns are never even opened.
                </p>
                ...
                <p>
                    You use an <strong>Asset Depletion Loan</strong>. The bank will look at your massive $5 Million brokerage account. They will divide that massive pile of cash by 360 months (30 years) to create a theoretical "monthly income" of $13,888. They use this theoretical income to approve your mortgage, proving that you could easily pay the bill simply by slowly depleting your assets, even if you never work another day in your life.
                </p>
