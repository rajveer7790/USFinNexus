...
export const metadata: Metadata = {
    title: 'Mortgage Amortization Explained: Where Your Payment Goes - USFinNexus 2026',
    ...
    openGraph: {
        ...
        description: 'Understand how your payment splits between principal and interest over time.',
        url: 'https://usfinnexus.com/blog/mortgage-amortization-schedule',
        type: 'article',
        siteName: 'USFinNexus',
    },
    alternates: {
        canonical: 'https://usfinnexus.com/blog/mortgage-amortization-schedule',
    },
};
...
export default function PostComponent() {
    return (
        ...
        <div className="max-w-4xl mx-auto px-4 py-7 sm:py-9">
            <Breadcrumbs items={[{ name: 'Blog', item: '/blog' }, { name: 'Mortgage Amortization Explained: Where Your Payment Goes', item: '/blog/mortgage-amortization-schedule' }]} />
            ...
            <div className="prose prose-lg max-w-none" style={{ color: 'var(--color-text)' }}>
                <p className="lead text-xl font-medium mb-8" style={{ color: 'var(--color-text-muted)' }}>
                    Understand how your payment splits between principal and interest over time.
                </p>
