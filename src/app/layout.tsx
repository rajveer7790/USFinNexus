...
export const metadata: Metadata = {
    ...
    description:
        'Free U.S. mortgage and personal finance calculators for monthly payments, affordability, refinancing, amortization, debt, taxes and more. No account required.',
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
    const organizationSchema = {
        ...
        name: 'USFinNexus',
        alternateName: ['US Fin Nexus', 'US Financial Nexus'],
        url: 'https://usfinnexus.com/',
        logo: {
            '@type': 'ImageObject',
            url: 'https://usfinnexus.com/icon-512.png',
    ...
    const websiteSchema = {
        ...
        description: 'Free U.S. mortgage and personal finance calculators.',
