...
export const metadata: Metadata = {
    ...
    openGraph: {
        title: 'BOI Exemption Confirmed 2026: Free Checklist for US LLCs',
        description: 'Use our free 4-step checklist to determine if your US LLC qualifies for the 2026 FinCEN BOI Domestic Exemption. Stop paying for compliance you no longer need.',
        url: 'https://usfinnexus.com/articles/boi-exemption-confirmed-2026-free-checklist',
        type: 'article',
        siteName: 'USFinNexus',
        images: [{ url: 'https://usfinnexus.com/images/checklist_hero_1772351437548.png', width: 1200, height: 630, alt: 'Free checklist verifying federal BOI exemption status for US small businesses in 2026' }],
    },
    twitter: {
        card: 'summary_large_image',
        title: 'BOI Exemption Confirmed 2026: Free Checklist for US LLCs',
        description: 'Use our free 4-step checklist to determine if your US LLC qualifies for the 2026 FinCEN BOI Domestic Exemption. Stop paying for compliance you no longer need.',
        images: ['https://usfinnexus.com/images/checklist_hero_1772351437548.png'],
    },
    alternates: {
        canonical: 'https://usfinnexus.com/articles/boi-exemption-confirmed-2026-free-checklist',
    },
};
        ...
        <article className="max-w-4xl mx-auto px-4 py-7 sm:py-9 lg:px-8">
            ...
            <div className="prose prose-lg max-w-none prose-headings:font-bold prose-a:text-blue-600 hover:prose-a:text-blue-500">
                <figure className="my-10">
                    <div className="relative w-full h-[350px] md:h-[450px] rounded-2xl overflow-hidden shadow-2xl border border-gray-100">
                        <Image
                            src="/images/checklist_hero_1772351437548.png"
                ...
                <div className="bg-white border border-gray-200 rounded-2xl p-6 md:p-8 my-10 shadow-sm not-prose">

                    <div className="flex items-start gap-5 mb-8">
                        <div className="flex-shrink-0 mt-1">
                            <div className="w-8 h-8 rounded border-2 border-gray-300 flex items-center justify-center bg-gray-50">
                                {/* Simulated checkbox */}
                            </div>
                        </div>
                        <div>
                            <h3 className="text-xl font-bold mb-2 text-gray-900">1. 100% U.S. Persons Ownership</h3>
                    ...
                    <div className="flex items-start gap-5 mb-8">
                        ...
                        <div>
                            <h3 className="text-xl font-bold mb-2 text-gray-900">2. Physical U.S. Operations</h3>
                            <p className="text-gray-600 mb-0">
                    ...
                    <div className="flex items-start gap-5 mb-8">
                        ...
                        <div>
                            <h3 className="text-xl font-bold mb-2 text-gray-900">3. Direct Ownership Structure</h3>
                            <p className="text-gray-600 mb-0">
                    ...
                    <div className="flex items-start gap-5">
                        ...
                        <div>
                            <h3 className="text-xl font-bold mb-2 text-gray-900">4. Good Standing Status</h3>
                            <p className="text-gray-600 mb-0">
