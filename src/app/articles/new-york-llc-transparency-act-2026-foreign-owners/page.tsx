...
import { ArrowLeft, AlertTriangle, ShieldCheck, MapPin, Search } from 'lucide-react';
        ...
        <article className="max-w-4xl mx-auto px-4 py-12 md:py-20 lg:px-8">
            ...
            <header className="mb-12">
                <div className="flex flex-wrap items-center gap-3 mb-6">
                    <span className="inline-block px-3 py-1 rounded bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-400 text-xs font-bold uppercase tracking-wider">
                        State Compliance
                    </span>
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none prose-headings:font-bold prose-a:text-blue-600 hover:prose-a:text-blue-500">
                ...
                <div className="bg-orange-50 dark:bg-orange-900/20 border-l-4 border-orange-500 p-6 my-8">
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            <p className="font-bold text-orange-900 dark:text-orange-300 m-0 mb-2">The NY-Specific Danger</p>
                            <p className="text-orange-800 dark:text-orange-200 m-0">
                ...
                <ul className="list-none pl-0 space-y-4 my-8 not-prose">
                    <li className="flex gap-4 items-start p-4 bg-gray-50 dark:bg-gray-900 rounded-lg border border-gray-100 dark:border-gray-800">
                        ...
                        <div>
                            <strong className="block text-gray-900 dark:text-gray-100 mb-1">Existing NY LLCs (Formed before Jan 1, 2026)</strong>
                            <span className="text-gray-600 dark:text-gray-400 text-sm">You have until January 1, 2027 to file your initial report with the state.</span>
                        </div>
                    </li>
                    <li className="flex gap-4 items-start p-4 bg-gray-50 dark:bg-gray-900 rounded-lg border border-gray-100 dark:border-gray-800">
                        <ShieldCheck className="w-6 h-6 text-green-500 shrink-0 mt-0.5" />
                        <div>
                            <strong className="block text-gray-900 dark:text-gray-100 mb-1">New NY LLCs (Formed on or after Jan 1, 2026)</strong>
                            <span className="text-gray-600 dark:text-gray-400 text-sm">You must file the disclosure within 30 days of filing your articles of organization.</span>
                        </div>
                    </li>
                    <li className="flex gap-4 items-start p-4 bg-gray-50 dark:bg-gray-900 rounded-lg border border-gray-100 dark:border-gray-800">
                        <ShieldCheck className="w-6 h-6 text-green-500 shrink-0 mt-0.5" />
