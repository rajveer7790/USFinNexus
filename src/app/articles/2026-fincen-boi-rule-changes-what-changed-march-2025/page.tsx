...
export const metadata: Metadata = {
    ...
    openGraph: {
        title: '2026 FinCEN BOI Rule Changes: What Changed in March 2025',
        description: 'A comprehensive timeline and guide to the March 2025 FinCEN BOI rule changes that shaped the entire 2026 compliance landscape for American businesses.',
        url: 'https://usfinnexus.com/articles/2026-fincen-boi-rule-changes-what-changed-march-2025',
        type: 'article',
        siteName: 'USFinNexus',
        images: [{ url: 'https://usfinnexus.com/images/fincen_changes_hero_1772351375738.png', width: 1200, height: 630, alt: 'The 2025 BOI turning point and regulatory shift into 2026 compliance landscape' }],
    },
    twitter: {
        card: 'summary_large_image',
        title: '2026 FinCEN BOI Rule Changes: What Changed in March 2025',
        description: 'A comprehensive timeline and guide to the March 2025 FinCEN BOI rule changes that shaped the entire 2026 compliance landscape for American businesses.',
        images: ['https://usfinnexus.com/images/fincen_changes_hero_1772351375738.png'],
    },
    alternates: {
        canonical: 'https://usfinnexus.com/articles/2026-fincen-boi-rule-changes-what-changed-march-2025',
    },
};
...
export default function ArticlePage() {
    return (
        ...
        <article className="max-w-4xl mx-auto px-4 py-12 md:py-20 lg:px-8">
            <Breadcrumbs items={[{ name: 'Articles', item: '/articles' }, { name: 'FinCEN Rule Changes', item: '/articles/2026-fincen-boi-rule-changes-what-changed-march-2025' }]} />
            ...
            <div className="prose prose-lg max-w-none prose-headings:font-bold prose-a:text-blue-600 hover:prose-a:text-blue-500">
                <figure className="my-10">
                    <div className="relative w-full h-[400px] md:h-[500px] rounded-2xl overflow-hidden shadow-2xl border border-gray-100">
                        <Image
                            src="/images/fincen_changes_hero_1772351375738.png"
                ...
                <div className="bg-blue-50 border-l-4 border-blue-500 p-6 my-8">
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            <p className="font-bold text-blue-900 m-0 mb-2">The March 2025 Resolution</p>
