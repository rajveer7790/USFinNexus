...
import { ArrowLeft, CheckCircle2, Shield, FileText, DollarSign, Info } from 'lucide-react';
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none prose-headings:font-bold prose-a:text-blue-600 hover:prose-a:text-blue-500">
                <figure className="my-10">
                    <div className="relative w-full h-[400px] md:h-[500px] rounded-2xl overflow-hidden shadow-2xl border border-gray-100 dark:border-gray-800 bg-gray-100 dark:bg-gray-800">
                        <Image src="/images/compliance-checklist.png" alt="FinCEN and IRS compliance checklist for US LLCs" fill className="object-cover" priority />
                    </div>
                    <figcaption className="text-center text-sm mt-3 text-gray-500 dark:text-gray-400">Your comprehensive 2026 compliance roadmap covering every federal obligation.</figcaption>
                </figure>
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-600 p-6 my-8 rounded-r-xl">
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            <h3 className="text-xl font-bold text-blue-900 dark:text-blue-300 m-0 mb-2">The 2026 Compliance Trinity</h3>
                ...
                <ul className="list-none pl-0 space-y-4 my-8 not-prose">
                    <li className="flex gap-4 items-start p-4 bg-white dark:bg-gray-900 rounded-lg border border-gray-100 dark:border-gray-800 shadow-sm">
                        ...
                        <div>
                            <strong className="block text-gray-900 dark:text-gray-100 mb-1">Determine Your Exemption Status</strong>
                            <span className="text-gray-600 dark:text-gray-400 text-sm">If your LLC is 100% domestically owned, in good standing, and has a physical U.S. address, you are exempt from federal BOI filing.</span>
                        </div>
                    </li>
                    <li className="flex gap-4 items-start p-4 bg-white dark:bg-gray-900 rounded-lg border border-gray-100 dark:border-gray-800 shadow-sm">
                        <CheckCircle2 className="w-6 h-6 text-green-500 shrink-0 mt-0.5" />
                        <div>
                            <strong className="block text-gray-900 dark:text-gray-100 mb-1">Foreign Owners: File Within 30 Days</strong>
                            <span className="text-gray-600 dark:text-gray-400 text-sm">If you have any foreign ownership, your initial BOI report must be filed within 30 calendar days of formation or registration.</span>
                        </div>
                    </li>
                    <li className="flex gap-4 items-start p-4 bg-white dark:bg-gray-900 rounded-lg border border-gray-100 dark:border-gray-800 shadow-sm">
                        <CheckCircle2 className="w-6 h-6 text-green-500 shrink-0 mt-0.5" />
                        <div>
                            <strong className="block text-gray-900 dark:text-gray-100 mb-1">Update Reports for Ownership Changes</strong>
                            <span className="text-gray-600 dark:text-gray-400 text-sm">Any change in beneficial ownership must be reported within 30 days of the change.</span>
                        </div>
                    </li>
                </ul>
                ...
                <ul className="list-none pl-0 space-y-4 my-8 not-prose">
                    <li className="flex gap-4 items-start p-4 bg-white dark:bg-gray-900 rounded-lg border border-gray-100 dark:border-gray-800 shadow-sm">
                        ...
                        <div>
                            <strong className="block text-gray-900 dark:text-gray-100 mb-1">All-Cash Purchases After March 1, 2026</strong>
                            <span className="text-gray-600 dark:text-gray-400 text-sm">If your LLC buys residential property without a mortgage, a Real Estate Report must be filed within 30 days of closing.</span>
                        </div>
                    </li>
                    <li className="flex gap-4 items-start p-4 bg-white dark:bg-gray-900 rounded-lg border border-gray-100 dark:border-gray-800 shadow-sm">
                        <Shield className="w-6 h-6 text-blue-500 shrink-0 mt-0.5" />
                        <div>
                            <strong className="block text-gray-900 dark:text-gray-100 mb-1">Cooperate with Your Settlement Agent</strong>
                            <span className="text-gray-600 dark:text-gray-400 text-sm">Provide all beneficial owner IDs and information promptly. The settlement agent bears primary filing liability, but you must cooperate.</span>
                        </div>
                    </li>
                </ul>
                ...
                <ul className="list-none pl-0 space-y-4 my-8 not-prose">
                    <li className="flex gap-4 items-start p-4 bg-white dark:bg-gray-900 rounded-lg border border-gray-100 dark:border-gray-800 shadow-sm">
                        ...
                        <div>
                            <strong className="block text-gray-900 dark:text-gray-100 mb-1">March 15: Partnership/S-Corp Returns Due</strong>
                            <span className="text-gray-600 dark:text-gray-400 text-sm">File Form 1065 (partnerships) or Form 1120-S (S-corps) and issue K-1s to all members/shareholders.</span>
                        </div>
                    </li>
                    <li className="flex gap-4 items-start p-4 bg-white dark:bg-gray-900 rounded-lg border border-gray-100 dark:border-gray-800 shadow-sm">
                        <DollarSign className="w-6 h-6 text-yellow-500 shrink-0 mt-0.5" />
                        <div>
                            <strong className="block text-gray-900 dark:text-gray-100 mb-1">April 15: Personal Returns + Q1 Estimated Payments</strong>
                            <span className="text-gray-600 dark:text-gray-400 text-sm">File your personal Form 1040 including Schedule C or K-1 income, and make your first quarterly estimated tax payment.</span>
                        </div>
                    </li>
                    <li className="flex gap-4 items-start p-4 bg-white dark:bg-gray-900 rounded-lg border border-gray-100 dark:border-gray-800 shadow-sm">
                        <DollarSign className="w-6 h-6 text-yellow-500 shrink-0 mt-0.5" />
                        <div>
                            <strong className="block text-gray-900 dark:text-gray-100 mb-1">Claim the 20% QBI Deduction</strong>
                            <span className="text-gray-600 dark:text-gray-400 text-sm">Made permanent in 2025, ensure you&apos;re calculating and claiming your full QBI deduction on your return.</span>
                        </div>
                    </li>
                    <li className="flex gap-4 items-start p-4 bg-white dark:bg-gray-900 rounded-lg border border-gray-100 dark:border-gray-800 shadow-sm">
                        <FileText className="w-6 h-6 text-gray-500 shrink-0 mt-0.5" />
                        <div>
                            <strong className="block text-gray-900 dark:text-gray-100 mb-1">State Franchise Taxes and Annual Reports</strong>
                            <span className="text-gray-600 dark:text-gray-400 text-sm">Maintain good standing with your state to preserve your federal domestic BOI exemption.</span>
                        </div>
                    </li>
                </ul>
